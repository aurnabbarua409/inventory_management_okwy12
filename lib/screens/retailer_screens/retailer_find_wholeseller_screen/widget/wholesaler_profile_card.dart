...
class WholesalerProfileCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print("Wholesaler Card: ${wholesaler.storeInformation.businessName}, isSelected: $isSelected");
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildInfoRow(
                          AppIconsPath.buildingIcon, wholesaler.storeInformation.businessName),
                      const SpaceWidget(spaceHeight: 6),
                      _buildInfoRow(
                          AppIconsPath.telephoneIcon, wholesaler.email),
                      const SpaceWidget(spaceHeight: 6),
                      _buildInfoRow(AppIconsPath.mailIcon, wholesaler.email,
                          width: 170),
                      const SpaceWidget(spaceHeight: 6),
                      _buildInfoRow(
                          AppIconsPath.locationIcon, wholesaler.storeInformation.location,
  ...
  Widget _buildInfoRow(String icon, String text,
    ...
    return Row(
      ...
      children: [
        ...
        SizedBox(
          width: width == double.infinity ? null : ResponsiveUtils.width(width),
          child: TextWidget(
            text: text,
            fontSize: 12,
