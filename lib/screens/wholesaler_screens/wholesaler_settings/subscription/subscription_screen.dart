      ...
      body: Obx(
        () => Column(
          children: [
            ...
            !_controller.isSubscribed.value
                ? Column(
                    children: [
                      Padding(
                        ...
                        child: LinearPercentIndicator(
                          ...
                          percent: _controller.totalOrders.value > 50
                              ? 1
                              : _controller.totalOrders.value /
                                  50, // Adjust percentage as needed
                      ...
                      TextWidget(
                        text:
                            "${_controller.totalOrders.value}/50 Orders Used", //$orderNo
                        fontSize: 16,
