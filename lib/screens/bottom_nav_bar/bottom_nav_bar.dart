...
import 'package:inventory_app/screens/wholesaler_screens/wholesaler_new_orders_screen/wholesaler_new_orders_screen.dart';
...
class _BottomNavBarState extends State<BottomNavBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> _widgetOptions = userRole == UserRole.retailer
        ? [
        ...
        : [
            ...
            // WholesalerOrderHistoryScreen(),
            WholesalerOrderHistoryScreen(initialTabIndex: 0),
            WholesalerOrderHistoryScreen(initialTabIndex: 1),
